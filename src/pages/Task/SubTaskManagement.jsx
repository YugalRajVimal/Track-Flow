...
//   // Util component to display Task Meta (for top of modals)
//   function TaskMetaInfo({ taskMeta }) {
//     return (
//       <div className="rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50/70 to-white shadow flex flex-col gap-2 px-7 py-3 mb-4 justify-between">
...
//           <span className="text-sm font-extrabold text-blue-900">{taskMeta.TotalMTR}</span>
//         </div>
//       </div>
//     )
//   }
...
//       >
//         <>
//           {/* Show FabricType, PartyName, BuiltyNo, TotalMTR on top of modal */}
  ...
  return (
    <div className="min-h-screen bg-white">
      <WorkflowHeader
        ...
        subtitle="Load a task by ID, then add the program-level line items underneath it."
      />
      ...
      <div className="max-w-6xl mx-auto px-2 md:px-6 sm:px-10 pb-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between mb-7 gap-4">
          ...
          <button
            className="flex items-center gap-2 rounded-full bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold px-5 py-2.5 shadow-sm transition disabled:bg-gray-200 disabled:text-gray-400"
            onClick={openAddModal}
            disabled={!taskId}
          >
        ...
        {!taskId && (
          <div className="rounded-3xl border border-gray-200 bg-white">
            <EmptyState icon="🔎" text="Enter a Task ID above to manage its sub-tasks." />
          </div>
        )}
